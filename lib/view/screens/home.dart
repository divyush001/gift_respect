...
import 'package:gift_respect/view/screens/home_advanced.dart';
import 'package:gift_respect/view/screens/messages.dart';
...
class _PageViewExampleState extends State<Home> with TickerProviderStateMixin {
    ...
    return Stack(
      ...
      children: <Widget>[
        PageView(
          ...
          children: <Widget>[
            HomeAdvanced(),
            Spot(users: UserService().loadUsers()),
            Messages(),
          ],
        ),
        PageIndicator(
